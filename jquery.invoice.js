...
Invoice.prototype = {
     ...
     */
    newRow: function () {
        jQuery(".item-row:last").after('<tr class="item-row"><td class="item-name"><div class="delete-btn noPrint"><a class=' + $.opt.delete.substring(1) + ' href="javascript:;" title="Remove row">X</a></div><input type="text" class="form-control item" placeholder="तपशिल" type="text" list="mySuggestion"><datalist id="mySuggestion"><option>शर्ट</option><option>पॅन्ट</option><option>६वार साडी </option><option>९वार साडी </option><option>धोतर </option><option>लेडीज ड्रेस</option><option>शेरवानी </option><option>साडी</option><option>ब्लाऊज </option><option>कोट </option><option>जॅकेट</option><option>जर्किंग</option><option>सलवार </option><option>लेडीज कुर्ता </option><option>ओढणी </option><option>घागरा </option><option>ब्लॅंकेट </option><option>बेडशिट </option><option>मंडप कापड प्र. कि. </option></datalist></td><td><input class="form-control price" placeholder="नग" type="text"> </td><td><input class="form-control qty" placeholder="दर" type="text"></td><td><span class="total" style="color: #070707;">0.00</span></td></tr>');
